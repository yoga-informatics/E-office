...
if (!isset($_SESSION['akses']) || $_SESSION['akses'] !== 'Patuud') {
...
$query = "SELECT 
          ...
          WHERE tb_disposisi.tujuan_disposisi = 'Patuud' 
...
<body>
    <div class="header">
        ...
        <nav>
            <ul>
                <li><a href="index_patuud.php">Dashboard</a></li>
                <li><a href="periksa_sm_Patuud.php">Periksa Surat Masuk</a></li>
